#
#  This code demo using RAGAS to evaluate RAG results on 10 questions:
#    1. context_precision
#    2. context_recall
#    3. faithfulness
#    4. answer_relevance
#
#  For demo purpose, in this code, we assume we already have: 
#    1. Retrieved context chunks "contexts" from indexing
#    2. Genrated response "answers"
#
#  Input:
#    * questions
#    * ground_truth
#    * contexts (from indexing retreival, but here assumed)
#    * answers (from LLM generation, but here assume)
#
#  Output:
#    * "ragas_reval.csv" for 10 question comparison
# 
#  This demo corresponds to L2.17 class nearby 01:49:36.
#
...
from models import qwen_model as llms
# from models import qwen_plus_model as llms # change model
