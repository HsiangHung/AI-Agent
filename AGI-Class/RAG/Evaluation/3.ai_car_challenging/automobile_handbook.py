#
#  This code evaluates RAG results on 2 questions (mixture retrieval). 
#  Fix embedding = 256
#  
#  The demo process: 
...
compression_evaluate_result = exec_eval(compression_retriever, questions, ground_truths)
